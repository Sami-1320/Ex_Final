...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEx_FinalGameMode_Statics::NewProp_LaberintoFacade = { "LaberintoFacade", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AEx_FinalGameMode, LaberintoFacade), Z_Construct_UClass_ALaberintoFacade_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LaberintoFacade_MetaData), NewProp_LaberintoFacade_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEx_FinalGameMode_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEx_FinalGameMode_Statics::NewProp_LaberintoFacade,
...
struct Z_CompiledInDeferFile_FID_Users_samsa_Documents_Unreal_Projects_Ex_Final_Source_Ex_Final_Ex_FinalGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AEx_FinalGameMode, AEx_FinalGameMode::StaticClass, TEXT("AEx_FinalGameMode"), &Z_Registration_Info_UClass_AEx_FinalGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEx_FinalGameMode), 2108682373U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_samsa_Documents_Unreal_Projects_Ex_Final_Source_Ex_Final_Ex_FinalGameMode_h_3352569403(TEXT("/Script/Ex_Final"),
